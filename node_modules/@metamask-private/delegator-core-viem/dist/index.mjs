...
import { HybridDeleGator as HybridDeleGator2 } from "@metamask-private/delegation-abis";
...
import { HybridDeleGator as HybridDeleGator3 } from "@metamask-private/delegation-abis";
...
import { HybridDeleGator as HybridDeleGator4 } from "@metamask-private/delegation-abis";
...
import { HybridDeleGator as HybridDeleGator5 } from "@metamask-private/delegation-abis";
...
import { simulateContract as simulateContract6 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator2 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract7 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator3 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract8 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator4 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract9 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator5 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract10 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator6 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract11 } from "viem/actions";
...
import { MultiSigDeleGator as MultiSigDeleGator7 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract12 } from "viem/actions";
...
import { simulateContract as simulateContract13, writeContract } from "viem/actions";
...
import { DeleGatorCore as DeleGatorCore2 } from "@metamask-private/delegation-abis";
import { readContract as readContract2 } from "viem/actions";

// src/DelegationFramework/DeleGatorCore/methods/getEntryPoint.ts
import { DeleGatorCore as DeleGatorCore3 } from "@metamask-private/delegation-abis";
import { readContract as readContract3 } from "viem/actions";

// src/DelegationFramework/DeleGatorCore/methods/getNonce.ts
import { DeleGatorCore as DeleGatorCore4 } from "@metamask-private/delegation-abis";
...
import { DeleGatorCore as DeleGatorCore5 } from "@metamask-private/delegation-abis";
import { readContract as readContract5 } from "viem/actions";
var read = async (client, contractAddress) => await readContract5(client, {
...
import { DeleGatorCore as DeleGatorCore6 } from "@metamask-private/delegation-abis";
...
var encodeProxyCreationCode = (implementationAddress, initcode) => encodeDeployData({
...
import { DeleGatorCore as DeleGatorCore7 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract14 } from "viem/actions";
var simulate14 = (client, contractAddress, delegation) => {
  const abi = DeleGatorCore7.abi;
...
import { DeleGatorCore as DeleGatorCore8 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract15 } from "viem/actions";
...
import { DeleGatorCore as DeleGatorCore9 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract16 } from "viem/actions";
...
import { DeleGatorCore as DeleGatorCore10 } from "@metamask-private/delegation-abis";
import {
  encodeExecutionCalldata
} from "@metamask-private/delegation-utils";
import { simulateContract as simulateContract17 } from "viem/actions";
...
import { DeleGatorCore as DeleGatorCore11 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract18 } from "viem/actions";
...
var encodeCalls = (calls) => {
  ...
  const executions = calls.map(
    ({ to, value, data }) => createExecution(to, value, data)
  );
  return encode17(BATCH_DEFAULT_MODE, executions);
};
...
var read7 = async (client, entryPoint, contractAddress, key) => await readContract7(client, {
  address: entryPoint,
  abi: EntryPoint.abi,
...
import { simulateContract as simulateContract19, writeContract as writeContract2 } from "viem/actions";
...
import { simulateContract as simulateContract20, writeContract as writeContract3 } from "viem/actions";
import { DelegationManager as DelegationManager2 } from "@metamask-private/delegation-abis";
...
import { DelegationManager as DelegationManager3 } from "@metamask-private/delegation-abis";
import {
  encodePermissionContexts,
  encodeExecutionCalldatas
} from "@metamask-private/delegation-utils";
import { simulateContract as simulateContract21, writeContract as writeContract4 } from "viem/actions";
...
import { DelegationManager as DelegationManager4 } from "@metamask-private/delegation-abis";
import { readContract as readContract8 } from "viem/actions";
var read8 = async (client, contractAddress) => await readContract8(client, {
  address: contractAddress,
...
import { DelegationManager as DelegationManager5 } from "@metamask-private/delegation-abis";
import { readContract as readContract9 } from "viem/actions";
var read9 = async (client, contractAddress) => await readContract9(client, {
  address: contractAddress,
...
var read10 = async (client, contractAddress) => await readContract10(client, {
  address: contractAddress,
  abi: [
    {
      type: "function",
...
var read11 = async (client, contractAddress) => await readContract11(client, {
  address: contractAddress,
  abi: [
    {
      type: "function",
...
var read12 = async (client, contractAddress) => await readContract12(client, {
  address: contractAddress,
  abi: [
    {
      type: "function",
...
import { HybridDeleGator as HybridDeleGator7 } from "@metamask-private/delegation-abis";
import { readContract as readContract13 } from "viem/actions";
var read13 = async (client, hybridDeleGatorAddress, keyId) => await readContract13(client, {
  address: hybridDeleGatorAddress,
...
import { HybridDeleGator as HybridDeleGator8 } from "@metamask-private/delegation-abis";
import { readContract as readContract14 } from "viem/actions";
var read14 = async (client, hybridDeleGatorAddress) => await readContract14(client, {
  address: hybridDeleGatorAddress,
...
import { HybridDeleGator as HybridDeleGator9 } from "@metamask-private/delegation-abis";
import { readContract as readContract15 } from "viem/actions";
var read15 = async (client, hybridDeleGatorAddress) => await readContract15(client, {
  address: hybridDeleGatorAddress,
...
import { MultiSigDeleGator as MultiSigDeleGator9 } from "@metamask-private/delegation-abis";
import { readContract as readContract16 } from "viem/actions";
var read16 = async (client, multiSigDeleGatorAddress) => await readContract16(client, {
  address: multiSigDeleGatorAddress,
...
import { MultiSigDeleGator as MultiSigDeleGator10 } from "@metamask-private/delegation-abis";
import { readContract as readContract17 } from "viem/actions";
var read17 = async (client, multiSigDeleGatorAddress) => await readContract17(client, {
  address: multiSigDeleGatorAddress,
...
import { MultiSigDeleGator as MultiSigDeleGator11 } from "@metamask-private/delegation-abis";
import { readContract as readContract18 } from "viem/actions";
var read18 = async (client, multiSigDeleGatorAddress) => await readContract18(client, {
  address: multiSigDeleGatorAddress,
...
import { MultiSigDeleGator as MultiSigDeleGator12 } from "@metamask-private/delegation-abis";
import { readContract as readContract19 } from "viem/actions";
var read19 = async (client, multiSigDeleGatorAddress, signer) => await readContract19(client, {
  address: multiSigDeleGatorAddress,
...
import { MultiSigDeleGator as MultiSigDeleGator13 } from "@metamask-private/delegation-abis";
import { readContract as readContract20 } from "viem/actions";
var read20 = async (client, multiSigDeleGatorAddress) => await readContract20(client, {
  address: multiSigDeleGatorAddress,
...
var read21 = async (client, contractAddress) => await readContract21(client, {
  address: contractAddress,
...
import { Ownable2Step as Ownable2Step2 } from "@metamask-private/delegation-abis";
import { readContract as readContract22 } from "viem/actions";
var read22 = async (client, contractAddress) => await readContract22(client, {
  address: contractAddress,
...
import { Ownable2Step as Ownable2Step3 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract22, writeContract as writeContract5 } from "viem/actions";
...
import { Ownable2Step as Ownable2Step4 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract23, writeContract as writeContract6 } from "viem/actions";
...
import { Ownable2Step as Ownable2Step5 } from "@metamask-private/delegation-abis";
import { simulateContract as simulateContract24, writeContract as writeContract7 } from "viem/actions";
...
var read23 = async (client, contractAddress) => await readContract23(client, {
  address: contractAddress,
  abi: Pausable.abi,
  functionName: "paused"
});
...
import { simulateContract as simulateContract25, writeContract as writeContract8 } from "viem/actions";
var PauseAbi = [
  {
    type: "function",
    name: "pause",
...
import { simulateContract as simulateContract26, writeContract as writeContract9 } from "viem/actions";
var UnpauseAbi = [
  {
    type: "function",
    name: "unpause",
